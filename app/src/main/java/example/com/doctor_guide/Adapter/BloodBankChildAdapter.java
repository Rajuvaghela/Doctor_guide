...
import example.com.doctor_guide.Activity.BloodBank_and_stemcell_details_CategoryActivity;
...
public class BloodBankChildAdapter extends RecyclerView.Adapter<BloodBankChildAdapter.ViewHolder> {
    ...
    public BloodBankChildAdapter(Context context, List<DoctorName> list) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        Constant.l_id = doctornameList.get(position).getDoctor_l_id();
...
/*        holder.btnreadmore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context,BloodBank_and_stemcell_details_CategoryActivity.class);
