...
import example.com.doctor_guide.Model.PhotoGallery;
...
public class PhotoGalleryAdapter extends RecyclerView.Adapter<PhotoGalleryAdapter.ViewHolder> {
    private ArrayList<PhotoGallery> galleryList;
    private Context context;

    public PhotoGalleryAdapter(Context context, ArrayList<PhotoGallery> galleryList) {
    ...
    public PhotoGalleryAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.photo_gallery_design, viewGroup, false);
