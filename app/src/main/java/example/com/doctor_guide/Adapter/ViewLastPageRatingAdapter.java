...
/**
 * Created by raju on 25-09-2017.
 */


public class ViewLastPageRatingAdapter extends RecyclerView.Adapter<ViewLastPageRatingAdapter.MyViewHolder> {

    Context context;
    List<RatingModel> listuser = new ArrayList<>();

    public ViewLastPageRatingAdapter(Context context, List<RatingModel> listuser) {
