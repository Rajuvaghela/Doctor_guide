...
public class DoctorFullDetailAdapter extends RecyclerView.Adapter<DoctorFullDetailAdapter.MyViewHolder> {

    Context context;
    List<DetailsModel> listuser = new ArrayList<>();

    public DoctorFullDetailAdapter(Context context, List<DetailsModel> listuser) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_doc_full_list_gallery, parent, false);
