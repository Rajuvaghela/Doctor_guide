...
import example.com.doctor_guide.Activity.Extra_details_CategoryActivity;
...
public class ExtraChildAdapter extends RecyclerView.Adapter<ExtraChildAdapter.ViewHolder> {
    ...
    public ExtraChildAdapter(Context context, List<DoctorName> list) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.btnreadmore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, Extra_details_CategoryActivity.class);
                Constant.e_id = doctornameList.get(position).getDoctor_l_id();
