...
import example.com.doctor_guide.Other.DividerItemDecorationForExtra;
...
public class Extra_SubcategoryActivity extends AppCompatActivity {
...
//
//
        recyclerView.addItemDecoration(new DividerItemDecorationForExtra(this));
...
//        );
    ...
    private void getData() {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(Extra_SubcategoryActivity.this);
                    ...
                    public void onResponse(String responseString) {
                        ...
                        if (responseString != null) {
                            try {
                                ...
                                Toast.makeText(Extra_SubcategoryActivity.this, "No Data Available", Toast.LENGTH_SHORT).show();
                                e.printStackTrace();
                                progressDialog.dismiss();
...
//                        layoutManager = new LinearLayoutManager(this);
                        recyclerView.setLayoutManager(layoutManager);
                        adapter = new DoctorAdapter(Extra_SubcategoryActivity.this, doctorList);

                        recyclerView.setAdapter(adapter);
                        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(Extra_SubcategoryActivity.this, new RecyclerItemClickListener.OnItemClickListener() {
                            @Override
                            public void onItemClick(View view, int position) {
                                Intent it = new Intent(getApplicationContext(), Extra_list_CategoryActivity.class);
//                                it.putExtra(sub_id,doctorList.get(position).getSub__id());
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Extra_SubcategoryActivity.this, error.toString(), Toast.LENGTH_LONG).show();
                        progressDialog.dismiss();
                    }
                }) {
            @Override
